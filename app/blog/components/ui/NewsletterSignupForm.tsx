        ...
        >
          <div className="w-full">
            ...
            <input
              ...
              name={name}
              id="email"
              className="block w-full rounded-md  border border-primary bg-primary px-4 py-1.5 text-primary placeholder:text-tertiary focus:ring-inset focus:ring-indigo-600"
