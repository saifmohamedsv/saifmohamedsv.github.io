    ...
    <header className={clsx("relative top-0 z-20 bg-primary md:sticky")}>
      <nav className="lg mx-auto flex max-w-[700px] items-center justify-between gap-3 px-4 py-3 md:px-6">
        <Link href="/" className="shrink-0 text-primary">
          ...
          >
            <path
              d="M71.3589 0V46.585L0 105.127V58.5419L71.3589 0Z"
              fill="currentColor"
            />
            <path
              d="M71.3588 0V46.585L142.714 105.127V58.5419L71.3588 0Z"
              fill="currentColor"
            />
            <path
              d="M71.3589 235V188.411L0 129.869V176.454L71.3589 235Z"
              fill="currentColor"
            />
            <path
              d="M71 235.131V188.542L142.355 130V176.585L71 235.131Z"
              fill="currentColor"
            />
            <path
              d="M0 105.127L142.714 176.454V129.869L0 58.5419V105.127Z"
              fill="currentColor"
            />
          </svg>
        </Link>
